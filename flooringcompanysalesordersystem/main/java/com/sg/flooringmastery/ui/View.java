...
public class View {
    ...
    private final int AREA_MIN = 100;
    private final String CUSTOMER_NAME_PATTERN = "^[\\p{L}\\d, .'-]+$";
    ...
    EXPORT_ORDERS(5, "Export All Orders"),
    QUIT(6, "Quit");
    ...
    public Order getNewOrder(){
        ...
        Order order = new Order(io.readDate("Order Date [MM/dd/yyyy]: ", LocalDate.now(),LocalDate.MAX));
        String regx = CUSTOMER_NAME_PATTERN;
        Pattern pattern = Pattern.compile(regx,Pattern.CASE_INSENSITIVE);
        order.setCustomerName(io.readRequiredString("Customer Name: ", pattern));
